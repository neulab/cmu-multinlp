...
SPACE_BETWEEN_WORD = False  # TODO: add as a param
ENTITY_COUNT = 0
...
def output(infn, docnum, sentences):
    global output_directory, ENTITY_COUNT
...
def process(fn):
    ...
    with codecs.open(fn, encoding=INPUT_ENCODING) as f:
        ...
        for ln, l in enumerate(lines):
            ...
            # word, POS and BIO tag separated by space.
            # For conll 2003, the format is word, POS, syntatic chunk tag, 
            # and NER tag separated by space. Try all of them.
...
""" % (fail_count, len(filenames)), file=sys.stderr)
    ...
    print('#entity {}'.format(ENTITY_COUNT))
